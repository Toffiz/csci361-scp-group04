...
const mockThreads: ChatThread[] = [
    ...
    messages: [
      {
        ...
        senderRole: UserRole.CONSUMER,
        type: MessageType.TEXT,
        content: 'Do you have organic pasta options available?',
        read: true,
      ...
      },
      {
        ...
        senderRole: UserRole.SALES,
        type: MessageType.TEXT,
        content: 'Yes! We have durum wheat pasta in 500g and 1kg packages. Would you like a quote?',
        read: true,
  ...
  },
  {
    ...
    consumerId: 'consumer@scp.kz',
    consumerName: 'Alice Brown',
    assignedSalesId: 'sales3@scp.kz',
    assignedSalesName: 'Michael Chen',
    unreadCount: 1,
    escalated: false,
    ...
    messages: [
      {
        ...
        senderRole: UserRole.CONSUMER,
        type: MessageType.TEXT,
        content: 'I am interested in your tea and coffee products. Can you provide samples?',
        read: true,
      ...
      },
      {
        id: 'msg-14',
        threadId: 'thread-5',
        senderId: 'sales3@scp.kz',
        senderName: 'Michael Chen',
        senderRole: UserRole.SALES,
        type: MessageType.TEXT,
        content: 'Absolutely! We can send you sample packs of our Ceylon black tea and Arabica instant coffee. Please confirm your shipping address.',
        read: false,
